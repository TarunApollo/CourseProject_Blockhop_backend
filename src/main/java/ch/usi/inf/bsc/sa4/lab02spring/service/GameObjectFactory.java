...
public class GameObjectFactory {
    ...
    public GameObject createGameObject(int gid, Position pos) {
        return createGameObject(gid, pos, CreateObjectProperties.DEFAULT);
    }

    public GameObject createGameObject(int gid, Position pos, CreateObjectProperties properties) {
    ...
    private Box createBox(int gid, Position pos, CreateObjectProperties properties) {
        return new Box(gid, pos, properties.toBoxContent());
    }

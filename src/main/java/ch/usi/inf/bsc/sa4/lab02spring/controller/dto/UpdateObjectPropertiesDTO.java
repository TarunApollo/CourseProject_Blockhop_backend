...
// Example: a box update only contains box properties.
// See Jackson docs for JsonTypeInfo + JsonSubTypes usage.

/// Base contract for DTOs used to update properties of an object in a level.
///
/// The JSON payload is polymorphic and resolved through the `type` field so each
/// concrete object update can expose only the properties it needs.
